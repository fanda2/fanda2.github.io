...
botui.message.add({ delay: 500, content: "Hi, there" }).then(function() {
    botui.message
        .add({ delay: 610, content: "这里是山河" })
        .then(function() {
            botui.message.add({ delay: 700, content: "一个可爱的蓝孩子~" });
        })
        .then(function() {
            botui.action
                .button({
                    delay: 2000,
                    action: [
                        { icon: "play", text: "然后呢", value: "next" },
                        { icon: "stop", text: "给爷爬", value: "skip" },
                    ],
                })
                .then(function(a) {
                    "next" == a.value &amp;&amp; next();
...
var sure = function() {
        botui.message
            ...
            .then(function() {
                botui.message.add({ delay: 1000, content: "打我呀，笨蛋 ! " });
            })
            .then(function() {
                botui.message.add({
                    human: true,
    ...
    secondpart = function() {
        botui.message
            .add({ delay: 1400, content: "一名计算机专业的应届生" })
            .then(function() {
                botui.message.add({
                    type: "html",
            ...
            .then(function() {
                botui.message
                    ...
                    .then(function() {
                        botui.message
                            .add({ delay: 1500, content: "热爱游戏，精通英雄联盟" })
                            .then(function() {
                                botui.message
                                    .add({
                                        delay: 1500,
                                    ...
                                    .then(function() {
                                        botui.message
                                            .add({ delay: 1500, content: "你艾希我奶妈" })
                                            .then(function() {
                                                botui.action
                                                    .button({
                                                        delay: 1700,
                                                        addMessage: false,
                                                        action: [{ text: "爱吗", value: "why-mashiro" }],
                                                    })
                                                    .then(function(a) {
                                                        thirdpart();
                                                    });
        ...
        botui.message
            ...
            .then(function() {
                botui.action
                    .button({
                        delay: 1000,
                        action: [{ text: "为什么叫山河呢", value: "why-cat" }],
                    })
                    .then(function(a) {
                        fourthpart();
                    });
    ...
    fourthpart = function() {
        botui.message
            .add({ delay: 1000, content: "想到这个就是这个，没有为什么" })
            .then(function() {
                botui.action
                    .button({
                        delay: 1100,
                        action: [{ text: "域名有什么含义吗", value: "why-domain" }],
                    })
                    .then(function(a) {
                        fifthpart();
                    });
    ...
    fifthpart = function() {
        botui.message
            .add({ content: "某妖友转卖给我的域名，这个比较便宜" })
            .then(function() {
                botui.message
                    .add({ delay: 1600, content: "你都看到这里了，快给我打钱" })
                    .then(function() {
                        botui.message.add({
                            type: "html",
                            delay: 2000,
                            content: '<button style="cursor: pointer;line-height: normal;border: 0;color: #fff;font-size: 14px;margin-top: 10px;margin-bottom: 10px;padding: 7px 15px;border-radius: 4px;background: #777979;box-shadow: 2px 3px 4px 0 rgba(0, 0, 0, .25) " onclick="window.location.href=\'http://zyan.gq\'">点我</button>',
                        });
                    });
            });
    };